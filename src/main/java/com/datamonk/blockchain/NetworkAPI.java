...
public class NetworkAPI {
    ...
    public static void checkConfig() throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, MalformedURLException {
        out("\n\n\nRUNNING: End2endIT.\n");
    ...
    private static Channel constructChannel(String name, HFClient client, SampleOrg sampleOrg) throws Exception {
        ...
        ChannelConfiguration channelConfiguration = new ChannelConfiguration(new File(TEST_FIXTURES_PATH + "/channel-artifacts/" + name + ".tx"));
            ...
            */
            ...
            channel.sendTransaction(successful, orderers).thenApply(transactionEvent -> {
                ...
                try {
                    ...
                    transactionProposalRequest.setArgs(new String[] {"insert","{\"name\" : \"test2\",\"gender\": \"test2\",\"dob\" : \"30/01/1994\",\"aadhar_no\": \"test2\",\"pan_no\": \"test2\",\"address\": {\"address_line\": \"test2\",\"city\": \"test2\"},\"cibil_score\": 700,\"marital_status\": \"married\"}"});
                    ...
                    e.printStackTrace();
                    out("Failed invoking chaincode with error : " + e.getMessage());
                }
                ...
                try {
                    ...
                    queryByChaincodeRequest.setArgs(new String[] {"retrieve", "test2"});
            ...
            e.printStackTrace();
            out("Test failed with error : " + e.getMessage());
        }
    }
